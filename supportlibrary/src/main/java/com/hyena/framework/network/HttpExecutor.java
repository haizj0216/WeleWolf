...
public interface HttpExecutor {
	 ...
	 * @return result
	 */
	HttpResult doGet(String url, HttpRequestParams params, HttpListener httpListener);
	 ...
	 * @return result
	 */
	HttpResult doPost(String url, HttpRequestParams params, HttpListener httpListener);

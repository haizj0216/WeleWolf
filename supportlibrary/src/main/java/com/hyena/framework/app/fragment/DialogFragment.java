...
public class DialogFragment<T extends BaseUIFragmentHelper> extends
	...
	public Animator getInAnimator() {
		if (mAnimStyle == AnimStyle.STYLE_SCALE) {
			...
			//重置位置
			LayoutParams params = (LayoutParams) getContainerPanel().getLayoutParams();
	...
	public View onCreateViewImpl(Bundle savedInstanceState) {
		...
		LayoutParams contentPanelParams = new LayoutParams(
				width, height);
...
//		ViewHelper.setScaleY(getView(), (float) scale);
	...
	public interface OnCancelListener {
		void onCanel(DialogFragment<?> dialog);
	}
	...
	public interface OnDialogListener {
		 ...
		 * 按钮点击监听器
		 */
		void onItemClick(DialogFragment<?> dialog, int btnId);
	}
	...
	protected void initTitleBar() {
		...
		if (mContentPanel != null) {
			mContentPanel.addView(mTitleDevider = getDividerLine(),
					deviderParams);
		}
	}
	...
	protected void initCtrlPanel() {
		...
		if (mContentPanel != null) {
			mContentPanel.addView(mCtrlDevider = getDividerLine(),
					deviderTopParams);
		}
		...
		mButtonPanel.addView(mBtnDevider = getButtonDividerLine(),

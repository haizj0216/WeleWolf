...
public class HybirdWebView extends WebView {
	...
	public interface WebViewActionListener {
		 ...
		 * Web页面请求方法调用
		 */
		void onCallMethod(String methodName,
	...
	private void init() {
		mWebChromeClientWrapper = new WebChromeClientWrapper() {
			...
			public boolean onJsPrompt(WebView view, String url, String message
				...
				LogUtil.v(TAG, "onJsPrompt --> " + message);
	...
	public void getWebViewSize() {
		...
		js.append("var h=document.body.scrollHeight;");
		js.append("prompt(\"hybird://method/sizeChange?w=\" + w + \"&h=\" + h, '');");

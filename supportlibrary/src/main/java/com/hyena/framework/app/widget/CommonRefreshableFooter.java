...
public class CommonRefreshableFooter extends AbsRefreshablePanel {
    ...
    public int getContentHeight() {
        return UIUtils.dip2px(getContext(), 50);
    }
    ...
    private void initView(){
        ...
        int ivSize = UIUtils.dip2px(getContext(), 26);
        int ivPadding = UIUtils.dip2px(getContext(), 3);
        ...
        ivParams.rightMargin = UIUtils.dip2px(getContext(), 10);

...
public class BaseUIFragment<T extends BaseUIFragmentHelper> extends BaseSubFragment {
    ...
    public T getUIFragmentHelper(){
        if (mUIFragmentHelper == null) {
            ...
            if (navigateService != null) {
                mUIFragmentHelper = navigateService.getUIFragmentHelper(this);
            }
        }
	...
	public static <T extends BaseUIFragment> T newFragment(Activity activity,
        ...
        initFragment(activity, fragment, animType);
        return fragment;
    }

    public static void initFragment(Activity activity, BaseUIFragment fragment, AnimType animType) {
        //设置导航控制器
        NavigateService navigateService = (NavigateService) activity.getSystemService(NavigateService.SERVICE_NAME);
        if(navigateService != null) {
            fragment.setParent(activity, null);//clear parent for no reason
            fragment.setAnimationType(animType);
            //设置导航帮助类
            fragment.setUIFragmentHelper(navigateService.getUIFragmentHelper(fragment));
        }
    }
	...
	public final View onCreateViewImpl(ViewGroup container, Bundle savedInstanceState) {
        ...
        LayoutParams statusBarParams = new LayoutParams(
    ...
    /**
     * <p>ViewPager中Fragment延迟加载使用，其他情况下请不要使用 </p>
     * <p>延迟加载 </p>
     */

...
public class SimpleRecycleView extends RecyclerView {
    ...
    private OnScrollListener mScrollListener = new OnScrollListener() {
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            ...
            int childCnt = layoutManager.getChildCount();
            ...
            if (childCnt > 0 && newState == RecyclerView.SCROLL_STATE_IDLE
                    && itemCount == lastVisiblePosition + 1 && mOnLastItemVisibleListener != null) {

...
public class ActionUtils {
    ...
    public static final String ACTION_VIRTUAL_TIPS = "com.buang.welewolf.action_virtualtip";
    public static final String ACTION_SUBJECTINFO_CHANGE = "com.knowbox.subjectinfo.changed";
    public static final String ACTION_MAIN_TAB = "com.buang.welewolf.main_tab";
    public static final String ACTION_CLASS_TRANSFER_CHANGED = "com.buang.welewolf_class_transfer_changed";
    public static final String ACTION_MATCH_CHANGED = "com.buang.welewolf_match_changed";
    public static final String ACTION_SHOW_REDBADGE = "com.buang.welewolf_red_badge";

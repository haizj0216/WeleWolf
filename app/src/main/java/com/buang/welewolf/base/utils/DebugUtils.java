...
public class DebugUtils {
	...
	// 堆栈日志文件名称
	private static final String FILE_NAME = "bdebug.txt";
	// 数据库文件名称
	private static final String DB_FILENAME = "knowbox.db";
	...
	public static void clearAllCache(){
		...
		File cache = DirContext.getImageCacheDir();
		FileUtils.delDirectory(cache.getAbsolutePath());
	}
}

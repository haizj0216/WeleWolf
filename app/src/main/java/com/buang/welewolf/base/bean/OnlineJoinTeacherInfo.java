...
public class OnlineJoinTeacherInfo extends BaseObject {
    ...
    public List<OnlineActivityDetailInfo.JoinTeacherInfo> joinList = new ArrayList<OnlineActivityDetailInfo.JoinTeacherInfo>();
    ...
    public void parse(JSONObject json) {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            OnlineActivityDetailInfo.JoinTeacherInfo joinTeacherInfo = new OnlineActivityDetailInfo.JoinTeacherInfo(jsonObject);

...
public class BoxLoadingView extends LoadingView {
    ...
    private void initView() {
        View.inflate(getContext(), com.buang.welewolf.R.layout.layout_loading, this);
        mLoadingView_1 = findViewById(com.buang.welewolf.R.id.loading_layout_1);//蜡笔小新
        mLoadingView_3 = findViewById(com.buang.welewolf.R.id.loading_layout_3);//小象奔跑

        mLoadingHintTxt = (TextView) findViewById(com.buang.welewolf.R.id.loading_hint);
        mLoadingImg = (ImageView) findViewById(com.buang.welewolf.R.id.loading_anim);

        mLoadingHintTxt_3 = (TextView) findViewById(com.buang.welewolf.R.id.loading_hint_3);
        mLoadingImg_3 = (ImageView) findViewById(com.buang.welewolf.R.id.loading_anim_3);

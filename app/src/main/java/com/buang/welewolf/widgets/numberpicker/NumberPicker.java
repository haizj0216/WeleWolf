...
package com.buang.welewolf.widgets.numberpicker;
 ...
 * </p>
 */
@SuppressLint({ "NewApi", "ClickableViewAccessibility", "MissingSuperCall" })
// @Widget
...
public class NumberPicker extends LinearLayout {
	...
	public NumberPicker(Context context, AttributeSet attrs) {
		this(context, attrs, com.buang.welewolf.R.attr.numberPickerStyle);
	}
	...
	public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray attributesArray = context.obtainStyledAttributes(attrs,
				com.buang.welewolf.R.styleable.NumberPicker, defStyle, 0);
		final int layoutResId = attributesArray.getResourceId(
				com.buang.welewolf.R.styleable.NumberPicker_internalLayout,
				DEFAULT_LAYOUT_RESOURCE_ID);

		mHasSelectorWheel = (layoutResId != DEFAULT_LAYOUT_RESOURCE_ID);

		mSolidColor = attributesArray.getColor(
				com.buang.welewolf.R.styleable.NumberPicker_solidColor, 0);

		mSelectionDivider = attributesArray
				.getDrawable(com.buang.welewolf.R.styleable.NumberPicker_selectionDivider);
		...
		mSelectionDividerHeight = attributesArray.getDimensionPixelSize(
				com.buang.welewolf.R.styleable.NumberPicker_selectionDividerHeight,
		...
		mSelectionDividersDistance = attributesArray.getDimensionPixelSize(
				com.buang.welewolf.R.styleable.NumberPicker_selectionDividersDistance,
				defSelectionDividerDistance);

		mMinHeight = attributesArray.getDimensionPixelSize(
				com.buang.welewolf.R.styleable.NumberPicker_internalMinHeight, SIZE_UNSPECIFIED);

		mMaxHeight = attributesArray.getDimensionPixelSize(
				com.buang.welewolf.R.styleable.NumberPicker_internalMaxHeight, SIZE_UNSPECIFIED);
		...
		mMinWidth = attributesArray.getDimensionPixelSize(
				com.buang.welewolf.R.styleable.NumberPicker_internalMinWidth, SIZE_UNSPECIFIED);

		mMaxWidth = attributesArray.getDimensionPixelSize(
				com.buang.welewolf.R.styleable.NumberPicker_internalMaxWidth, SIZE_UNSPECIFIED);
		...
		mVirtualButtonPressedDrawable = attributesArray
				.getDrawable(com.buang.welewolf.R.styleable.NumberPicker_virtualButtonPressedDrawable);
		...
		OnClickListener onClickListener = new OnClickListener() {
			public void onClick(View v) {
				...
				if (v.getId() == com.buang.welewolf.R.id.np__increment) {
		...
		if (!mHasSelectorWheel) {
			mIncrementButton = (ImageButton) findViewById(com.buang.welewolf.R.id.np__increment);
		...
		// decrement button
		if (!mHasSelectorWheel) {
			mDecrementButton = (ImageButton) findViewById(com.buang.welewolf.R.id.np__decrement);
		...
		// input text
		mInputText = (EditText) findViewById(com.buang.welewolf.R.id.np__numberpicker_input);
		mInputText.setFocusable(false);
		mInputText.setTextColor(getContext().getResources().getColor(com.buang.welewolf.R.color.color_main_app));
	...
	public void setMaxValue(int maxValue, boolean mark) {
	...
	class SetSelectionCommand implements Runnable {
		...
		public void run() {
			try {
				if (mInputText.getText().length() >= mSelectionEnd

...
public class DoubleRingProgress extends View {
	...
	public DoubleRingProgress(Context context, AttributeSet attrs,
		...
		TypedArray attributes = context.getTheme().obtainStyledAttributes(
				attrs, com.buang.welewolf.R.styleable.DoubleRingProgress, defStyleAttr, 0);
	...
	protected void initByAttributes(TypedArray attributes) {
		arcAngle = attributes.getDimension(
				com.buang.welewolf.R.styleable.DoubleRingProgress_arc_angle, default_arc_angle);
		setMax(attributes.getInt(com.buang.welewolf.R.styleable.DoubleRingProgress_arc_max,
				default_max));
		setInnerProgress(attributes.getInt(
				com.buang.welewolf.R.styleable.DoubleRingProgress_progress_inner, 0));
		innerStrokeWidth = attributes.getDimension(
				com.buang.welewolf.R.styleable.DoubleRingProgress_stroke_width_inner,
				default_stroke_width);
		innerFinishedStrokeColor = attributes.getColor(
				com.buang.welewolf.R.styleable.DoubleRingProgress_finished_color_inner,
				default_finished_color);
		innerUnfinishedStrokeColor = attributes.getColor(
				com.buang.welewolf.R.styleable.DoubleRingProgress_unfinished_color_inner,
				default_unfinished_color);

		setOutterProgress(attributes.getInt(
				com.buang.welewolf.R.styleable.DoubleRingProgress_progress_outter, 0));
		outterStrokeWidth = attributes.getDimension(
				com.buang.welewolf.R.styleable.DoubleRingProgress_stroke_width_outter,
				default_stroke_width);
		outterFinishedStrokeColor = attributes.getColor(
				com.buang.welewolf.R.styleable.DoubleRingProgress_finished_color_outter,
				default_finished_color);
		outterUnfinishedStrokeColor = attributes.getColor(
				com.buang.welewolf.R.styleable.DoubleRingProgress_unfinished_color_outter,
				default_unfinished_color);

		fillColor = attributes.getColor(
				com.buang.welewolf.R.styleable.DoubleRingProgress_fill_color, default_fill_color);
	}

...
package com.buang.welewolf.widgets.pinned_listview;
...
public class PinnedHeaderListView extends ListView implements IIndexBarFilter {
	...
	int mHeaderViewWidth, mHeaderViewHeight, mIndexBarViewWidth,
			mIndexBarViewHeight, mIndexBarViewMargin, mPreviewTextViewWidth,
	...
	public void setIndexBarView(View indexBarView) {
		mIndexBarViewMargin = (int) mContext.getResources().getDimension(
				com.buang.welewolf.R.dimen.index_bar_view_margin);
	...
	protected void onLayout(boolean changed, int left, int top, int right,
		...
		if (mPreviewTextView != null && mPreviewVisibility) {
			mPreviewTextView.layout(mIndexBarView.getLeft()
					- mPreviewTextViewWidth, (int) mIndexBarY
					- (mPreviewTextViewHeight / 2), mIndexBarView.getLeft(),
					(int) (mIndexBarY - (mPreviewTextViewHeight / 2))
							+ mPreviewTextViewHeight);
		}
	}

...
public class IndexBarView extends View {
    ...
    public void setData(PinnedHeaderListView listView, List<PinyinIndexModel> listItems,ArrayList<Integer> listSections) {
    ...
    public String getSectionText(int sectionPosition) {
        return mListItems.get(sectionPosition).getName();
    }
    ...
    void filterListItem(float sideIndexY) {
        ...
        if (mCurrentSectionPosition >= 0 && mCurrentSectionPosition < mListSections.size()) {
            ...
            String previewText = mListItems.get(position).getName();

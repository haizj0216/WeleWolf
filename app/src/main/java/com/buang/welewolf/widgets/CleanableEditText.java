...
//			mEditText.setFocusable(true);
	...
	protected void onFinishInflate() {
		...
		View.inflate(getContext(), com.buang.welewolf.R.layout.widget_edit_text, this);
		mEyeIcon = findViewById(com.buang.welewolf.R.id.edit_text_eye);
		mLeftIcon = (ImageView) findViewById(com.buang.welewolf.R.id.edit_text_lefticon);
		mEditText = (EditText) findViewById(com.buang.welewolf.R.id.edit_text_edt);
		...
		mClearBtn = findViewById(com.buang.welewolf.R.id.edit_text_clear);

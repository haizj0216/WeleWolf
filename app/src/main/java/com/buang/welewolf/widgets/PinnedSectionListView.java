...
public class PinnedSectionListView extends ListView {
    ...
    public static interface PinnedSectionListAdapter extends ListAdapter {
        ...
        public abstract boolean isItemViewTypePinned(int viewType);
    }
    ...
    public void initFooter(){
        ...
        mFootView.setBackgroundColor(getResources().getColor(com.buang.welewolf.R.color.color_white_100));

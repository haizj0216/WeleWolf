...
public class LoopWordInfoFragment extends BaseUIFragment<UIFragmentHelper> {
    ...
    public View onCreateViewImpl(Bundle savedInstanceState) {
        return View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_loop_word_detail, null);
    }
    ...
    public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
        ...
        mTranslation = (TextView) view.findViewById(com.buang.welewolf.R.id.loop_word_detail_translation);
        mDimLayout = (LinearLayout) view.findViewById(com.buang.welewolf.R.id.loop_word_detail_dim);
        mViewPager = (ViewPager) view.findViewById(com.buang.welewolf.R.id.loop_word_detail_viewpager);
        mScrollView = (HorizontalScrollView) view.findViewById(com.buang.welewolf.R.id.loop_word_detail_dim_scroll);
    ...
    private void updateData() {
        ...
        if (mLoopWordDetailInfo.questionDimInfos != null && mLoopWordDetailInfo.questionDimInfos.size() > 0) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                final View view = View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_loop_word_detail_dim_item, null);
                TextView dimTitle = (TextView) view.findViewById(com.buang.welewolf.R.id.loop_word_detail_dim_title);
                TextView dimCount = (TextView) view.findViewById(com.buang.welewolf.R.id.loop_word_detail_dim_count);
                ImageView dimImage = (ImageView) view.findViewById(com.buang.welewolf.R.id.loop_word_detail_dim_image);

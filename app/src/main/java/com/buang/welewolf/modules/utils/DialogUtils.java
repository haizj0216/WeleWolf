...
import com.buang.welewolf.base.bean.OnlineHomeworkSectionsInfo;
import com.buang.welewolf.base.bean.OnlinePaperFilterInfo;
...
import com.buang.welewolf.base.bean.OnlineQuestionDetailInfo.QuestionAnswer;
...
//			Selection.setSelection(edit.getText(), edit.getText().length());
	...
	public static Dialog getSelectGradeDialog(Context context,
		...
		View view = View.inflate(context, com.buang.welewolf.R.layout.regist_select_grade, null);
		final NumberPicker yearsPicker = (NumberPicker) view
				.findViewById(com.buang.welewolf.R.id.select_years);
		final NumberPicker gradePicker = (NumberPicker) view
				.findViewById(com.buang.welewolf.R.id.select_grade);
	...
	public static Dialog getSelectTeachingInfoDialog(Context context,
		...
		View view = View.inflate(context, com.buang.welewolf.R.layout.regist_select_teachinginfo,
				null);
		final NumberPicker sectionPicker = (NumberPicker) view
				.findViewById(com.buang.welewolf.R.id.select_section);
		final NumberPicker subjectPicker = (NumberPicker) view
				.findViewById(com.buang.welewolf.R.id.select_subject);
	...
	public static Dialog getAnswerDetailDialog(Context context,
		...
		View view = View.inflate(context, com.buang.welewolf.R.layout.dialog_answer_detail, null);
		TextView detail = (TextView) view
				.findViewById(com.buang.welewolf.R.id.dialog_answer_detail_content);
		TextView studentCnt = (TextView) view
				.findViewById(com.buang.welewolf.R.id.dialog_answer_detail_studentcnt);
		TextView rightRate = (TextView) view
				.findViewById(com.buang.welewolf.R.id.dialog_answer_detail_rightrate);
		GridView studentGrid = (GridView) view
				.findViewById(com.buang.welewolf.R.id.dialog_answer_detail_studentlist);
		...
		if (!TextUtils.isEmpty(rightAnswer)) {
			if (rightAnswer.equals(answer.mCode)
				...
				detail.setTextColor(context.getResources().getColor(com.buang.welewolf.R.color.color_main_app));
			}
		}
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if (convertView == null) {
					convertView = View.inflate(mContext,
							com.buang.welewolf.R.layout.dialog_answer_detail_item, null);
					holder = new ViewHolder();
					holder.mStudentName = (TextView) convertView
							.findViewById(com.buang.welewolf.R.id.dialog_answer_detail_item_studentname);
...
//	}
	...
	public static Dialog getKnowledgeSelectDialog(final Context context,
                                                  String title, final List<OnlineHomeworkSectionsInfo.SectionInfo> items,
                                                  final List<OnlineHomeworkSectionsInfo.SectionInfo> mSelectKnows, OnItemClickListener listener,
		...
		final SingleTypeAdapter<OnlineHomeworkSectionsInfo.SectionInfo> adapter = new SingleTypeAdapter<OnlineHomeworkSectionsInfo.SectionInfo>(
				context) {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if (convertView == null) {
					convertView = View.inflate(context,
							com.buang.welewolf.R.layout.layout_homework_section_dialog_item, null);
					holder = new ViewHolder();
				...
				OnlineHomeworkSectionsInfo.SectionInfo item = getItem(position);
				holder.mTitleTxt.setText(item.mSectionName);
				holder.mIcon.setImageResource(com.buang.welewolf.R.drawable.bg_checkbox_markrmd);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
									int position, long id) {
				OnlineHomeworkSectionsInfo.SectionInfo info = items.get(position);
	...
	public static Dialog getSectionListDialog(final Context context,
                                              String title, List<OnlineHomeworkSectionsInfo.SectionInfo> items, OnItemClickListener listener) {
		View view = View.inflate(context, com.buang.welewolf.R.layout.dialog_common_list, null);
		ListView listView = (ListView) view
				.findViewById(com.buang.welewolf.R.id.dialog_common_list);
		SingleTypeAdapter<OnlineHomeworkSectionsInfo.SectionInfo> adapter = new SingleTypeAdapter<OnlineHomeworkSectionsInfo.SectionInfo>(
				context) {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if (convertView == null) {
					...
					holder.mDevider = convertView
							.findViewById(com.buang.welewolf.R.id.dialog_common_list_item_devider);
					holder.mDescTxt = (TextView) convertView.findViewById(com.buang.welewolf.R.id.dialog_common_list_item_desc);
					convertView.setTag(holder);
				} else {
					holder = (ViewHolder) convertView.getTag();
				}
	...
	public static PopupWindow getPaperFilterPop(final Context context, final String selectID,
		...
		View view = View.inflate(context, com.buang.welewolf.R.layout.dialog_paper_filter_pop,
				null);
		ListView listView = (ListView) view
				.findViewById(com.buang.welewolf.R.id.dialog_paper_filter_list);
		final SingleTypeAdapter<OnlinePaperFilterInfo.PaperFilterItem> adapter = new SingleTypeAdapter<OnlinePaperFilterInfo.PaperFilterItem>(
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if (selectID.equals(mValue)) {
					...
					holder.mName.setTextColor(context.getResources().getColor(com.buang.welewolf.R.color.color_main_app));
				} else {
					holder.mName.setTextColor(context.getResources().getColor(com.buang.welewolf.R.color.color_text_main));
...
//						}
	...
	public static PopupWindow getAssignFilterPop(final Context context,
		...
		View view = View.inflate(context, com.buang.welewolf.R.layout.dialog_classpart_filter_pop,
				null);
		ListView listView = (ListView) view
				.findViewById(com.buang.welewolf.R.id.dialog_paper_filter_list);
		...
		SingleTypeAdapter<String> adapter = new SingleTypeAdapter<String>(
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if (position == index) {
					...
					holder.mName.setTextColor(mContext.getResources().getColor(com.buang.welewolf.R.color.color_text_main));
					holder.mSelect.setVisibility(View.GONE);
				}
				return convertView;
			}

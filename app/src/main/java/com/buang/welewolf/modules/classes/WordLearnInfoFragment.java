...
import com.buang.welewolf.modules.classes.adapter.WordLearnAdapter;
...
public class WordLearnInfoFragment extends BaseUIFragment<UIFragmentHelper> {
    ...
    public View onCreateViewImpl(Bundle savedInstanceState) {
        return View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_word_learn_info, null);
    }
    ...
    public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
        ...
        mListView = (ListView) view.findViewById(com.buang.welewolf.R.id.word_learn_list);
        mAdapter = new WordLearnAdapter(this);

        View header = View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_word_learn_info_header, null);
        ((TextView) header.findViewById(com.buang.welewolf.R.id.word_learn_info_name)).setText("" + mWordInfo.content);
        mExplain = ((TextView) header.findViewById(com.buang.welewolf.R.id.word_learn_info_explain));
        mDesc = (TextView) header.findViewById(com.buang.welewolf.R.id.word_learn_info_desc);

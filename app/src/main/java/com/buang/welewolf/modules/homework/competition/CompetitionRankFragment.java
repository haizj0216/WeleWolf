...
import com.buang.welewolf.base.bean.OnlineCompetitionDetailsInfo;
...
public class CompetitionRankFragment extends BaseUIFragment<UIFragmentHelper> {
    ...
    public View onCreateViewImpl(Bundle savedInstanceState) {
        return View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_competition_rank, null);
    }
    ...
    public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
        ...
        mListView = (ListView) view.findViewById(com.buang.welewolf.R.id.competition_studentrank_list);
    ...
    class StudentRankAdapter extends SingleTypeAdapter<OnlineStudentInfo> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_competition_student_item, null);
                viewHolder.mItemRoot = (RelativeLayout) convertView.findViewById(com.buang.welewolf.R.id.ranking_item);
                viewHolder.mRankImg = (ImageView) convertView.findViewById(com.buang.welewolf.R.id.rank_img);
                viewHolder.mRankText = (TextView) convertView.findViewById(com.buang.welewolf.R.id.rank_text);
                viewHolder.mHeadPhoto = (ImageView) convertView.findViewById(com.buang.welewolf.R.id.student_head_photo);
                viewHolder.mStudentName = (TextView) convertView.findViewById(com.buang.welewolf.R.id.student_name);
                viewHolder.mScore = (TextView) convertView.findViewById(com.buang.welewolf.R.id.score);
                viewHolder.mMasterWordCount = (TextView) convertView.findViewById(com.buang.welewolf.R.id.master_word_count);
            ...
            ImageFetcher.getImageFetcher()
                    .loadImage(studentInfo.mHeadPhoto, viewHolder.mHeadPhoto, com.buang.welewolf.R.drawable.default_img, new RoundDisplayer());

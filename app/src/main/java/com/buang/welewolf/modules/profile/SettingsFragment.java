...
import com.buang.welewolf.base.utils.DebugUtils;
...
public class SettingsFragment extends BaseUIFragment<UIFragmentHelper> {
    ...
    public View onCreateViewImpl(Bundle savedInstanceState) {
        ...
        View view = View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_settings, null);
        return view;
    }
    ...
    public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
        ...
        ((TextView) view.findViewById(com.buang.welewolf.R.id.settings_user_phone_number))
                .setText(mUserItem.loginName);
        mCacheSizeText = (TextView) view.findViewById(com.buang.welewolf.R.id.settings_cache_size);
        view.findViewById(com.buang.welewolf.R.id.settings_modify_password_layout)
                .setOnClickListener(mOnClickListener);
        view.findViewById(com.buang.welewolf.R.id.settings_ablout_layout).setOnClickListener(
                mOnClickListener);
        view.findViewById(com.buang.welewolf.R.id.settings_clear_cache).setOnClickListener(
                mOnClickListener);
        view.findViewById(com.buang.welewolf.R.id.exit_app_layout).setOnClickListener(
                mOnClickListener);
        view.findViewById(com.buang.welewolf.R.id.profile_settings_notify_toggle).setOnClickListener(mOnClickListener);
        view.findViewById(com.buang.welewolf.R.id.settings_feedback_layout).setOnClickListener(mOnClickListener);

        mSwitchAPIlayout = (RelativeLayout) view.findViewById(com.buang.welewolf.R.id.settings_switchapi_layout);
        mCurrentAPI = (TextView) view.findViewById(com.buang.welewolf.R.id.type_api);
        ...
        ((ImageView) view.findViewById(com.buang.welewolf.R.id.profile_settings_notify_toggle)).setImageResource(notify
                ? com.buang.welewolf.R.drawable.btn_toggle_button_cache_on
                : com.buang.welewolf.R.drawable.btn_toggle_button_cache_off);
    ...
    private View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                // 修改密码
                case com.buang.welewolf.R.id.settings_modify_password_layout: {
                ...
                // 关于
                case com.buang.welewolf.R.id.settings_ablout_layout: {
                ...
                // 退出
                case com.buang.welewolf.R.id.exit_app_layout:
                    showLoginOutDialog();
                    UmengConstant.reportUmengEvent(UmengConstant.EVENT_LOGINOUT, null);
                    break;

                // 清除缓存
                case com.buang.welewolf.R.id.settings_clear_cache:
                    DebugUtils.clearAllCache();
                    refreshCacheSize();
                    ToastUtils.showShortToast(getActivity(), "缓存已清空");
                    break;
                case com.buang.welewolf.R.id.profile_settings_notify_toggle:
                    updateNotify(v);
                    break;

                case com.buang.welewolf.R.id.settings_feedback_layout:
                    openServiceChatFragment();
                    break;
                case com.buang.welewolf.R.id.settings_switchapi_layout:
                    //切换api
                    switchAPI();
                    break;
    ...
    private void updateNotify(View v) {
        ...
        ((ImageView) v).setImageResource(!notify ? com.buang.welewolf.R.drawable.btn_toggle_button_cache_on
                : com.buang.welewolf.R.drawable.btn_toggle_button_cache_off);
        if (notify) {

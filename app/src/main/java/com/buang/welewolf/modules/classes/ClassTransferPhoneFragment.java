...
public class ClassTransferPhoneFragment extends BaseUIFragment {
    ...
    public View onCreateViewImpl(Bundle savedInstanceState) {
        ...
        View view = View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_class_transfer_phone, null);
        return view;
    }
    ...
    public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
        ...
        mPhoneEdit = (CleanableEditText) view.findViewById(com.buang.welewolf.R.id.class_transfer_phone_edit);
        mPhoneEdit.getEditText().setTextColor(getActivity().getResources().getColor(com.buang.welewolf.R.color.color_text_main));
        mPhoneEdit.setInputType(
                InputType.TYPE_CLASS_PHONE | InputType.TYPE_TEXT_VARIATION_PHONETIC);
        mPhoneEdit.setDigist("1234567890");
        mNextButton = (Button) view.findViewById(com.buang.welewolf.R.id.class_transfer_phone_next);

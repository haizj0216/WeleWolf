...
import com.buang.welewolf.base.bean.OnlineLoopStudentDetailInfo;
import com.buang.welewolf.base.bean.OnlineReportStudentListInfo;
...
public class LoopStudentInfoFragment extends BaseUIFragment<UIFragmentHelper> {
    ...
    public View onCreateViewImpl(Bundle savedInstanceState) {
        return View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_loop_student_info, null);
    }
    ...
    public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
        ...
        mCountView = (TextView) view.findViewById(com.buang.welewolf.R.id.loop_student_info_count);
        mRateView = (TextView) view.findViewById(com.buang.welewolf.R.id.loop_student_info_rate);
        mCountTitle = (TextView) view.findViewById(com.buang.welewolf.R.id.loop_student_info_count_title);
        mRateTitle = (TextView) view.findViewById(com.buang.welewolf.R.id.loop_student_info_rate_title);
        mTypeView = (LinearLayout) view.findViewById(com.buang.welewolf.R.id.loop_student_question_type);
        mScoreView = (TextView) view.findViewById(com.buang.welewolf.R.id.loop_student_info_score);
        mTypeTitle = (TextView) view.findViewById(com.buang.welewolf.R.id.loop_student_question_type_title);
        mTitleView = (TextView) view.findViewById(com.buang.welewolf.R.id.loop_student_info_title);
        mEmptyView = view.findViewById(com.buang.welewolf.R.id.loop_student_info_empty);
        mTitleLayout = view.findViewById(com.buang.welewolf.R.id.loop_student_info_title_layout);
        mListView = (AccuracListView) view.findViewById(com.buang.welewolf.R.id.loop_student_info_listview);
    ...
    class StudentDetailAdapter extends SingleTypeAdapter<OnlineWordInfo> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_loop_student_detail_item, null);
                viewHolder = new ViewHolder();
                viewHolder.mWordName = (TextView) convertView.findViewById(com.buang.welewolf.R.id.loop_student_detail_item_word);
                viewHolder.mWordIndex = (TextView) convertView.findViewById(com.buang.welewolf.R.id.loop_student_detail_item_index);
                viewHolder.mDataLayout = (LinearLayout) convertView.findViewById(com.buang.welewolf.R.id.loop_student_detail_item_layout);
            ...
            for (int i = 0; i < wordInfo.wrongCountArray.length + 1; i++) {
                ...
                textView.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_text_primary));

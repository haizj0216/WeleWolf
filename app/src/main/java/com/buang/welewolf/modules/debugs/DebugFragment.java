package com.buang.welewolf.modules.debugs;
...
public class DebugFragment extends BaseUIFragment<UIFragmentHelper> {
	...
	public View onCreateViewImpl(Bundle savedInstanceState) {
		...
		return View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_debug, null);
	}
	...
	public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
		...
		mDebugSwitchBtn = ((ToggleButton) view
				.findViewById(com.buang.welewolf.R.id.debug_cansole_switch));
		mDebugSwitchBtn.setOnCheckedChangeListener(mOnCheckedChangeListener);
		mDebugSwitchBtn.setChecked(mDebugService.isDebug());

		view.findViewById(com.buang.welewolf.R.id.ping_layout)
				.setOnClickListener(mOnClickListener);

		// 默认不允许多端登录
		mAllowMultiNodeLogin = ((ToggleButton) view
				.findViewById(com.buang.welewolf.R.id.allow_multi_node_login_switch));
		...
		view.findViewById(com.buang.welewolf.R.id.copy_db_to_external_layout).setOnClickListener(
				mOnClickListener);
		view.findViewById(com.buang.welewolf.R.id.ping_layout)
				.setOnClickListener(mOnClickListener);
		view.findViewById(com.buang.welewolf.R.id.clear_default_db_layout).setOnClickListener(
				mOnClickListener);
		view.findViewById(com.buang.welewolf.R.id.app_detail_layout).setOnClickListener(
				mOnClickListener);
	}
	...
	private View.OnClickListener mOnClickListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			switch (v.getId()) {
			case com.buang.welewolf.R.id.ping_layout:
				new Thread(){
					public void run() {
						ping();
					}

...
import com.buang.welewolf.base.bean.OnlineStudentUnitListInfo;
...
import com.buang.welewolf.widgets.PinnedScrollView;
...
public class StudentUnitFragment extends BaseUIFragment<UIFragmentHelper> {
    ...
    public View onCreateViewImpl(Bundle savedInstanceState) {
        return View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_student_unit_info, null);
    }

    @Override
    public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
        super.onViewCreatedImpl(view, savedInstanceState);
        mHead = (ImageView) view.findViewById(com.buang.welewolf.R.id.student_unit_header_head);
        mName = (TextView) view.findViewById(com.buang.welewolf.R.id.student_unit_header_name);
        mLearned = (TextView) view.findViewById(com.buang.welewolf.R.id.student_unit_header_learned);
        mLearning = (TextView) view.findViewById(com.buang.welewolf.R.id.student_unit_header_learning);
        mWeekLearned = (TextView) view.findViewById(com.buang.welewolf.R.id.student_unit_header_learned_week);
        mWeekLearning = (TextView) view.findViewById(com.buang.welewolf.R.id.student_unit_header_learning_week);
        mLastLearned = (TextView) view.findViewById(com.buang.welewolf.R.id.student_unit_header_learned_lastday);
        mLastLearning = (TextView) view.findViewById(com.buang.welewolf.R.id.student_unit_header_learning_lastday);
        mGridView = (AccuracGridView) view.findViewById(com.buang.welewolf.R.id.student_unit_list);
        mBookView = (TextView) view.findViewById(com.buang.welewolf.R.id.student_unit_book);
        view.findViewById(com.buang.welewolf.R.id.student_unit_header_back).setOnClickListener(mOnClickListener);
        view.findViewById(com.buang.welewolf.R.id.student_unit_header_learned_rule).setOnClickListener(mOnClickListener);
        view.findViewById(com.buang.welewolf.R.id.student_unit_header_learning_rule).setOnClickListener(mOnClickListener);

        mScrollView = (PinnedScrollView) view.findViewById(com.buang.welewolf.R.id.student_unit_scrollview);
        View pinnedView = View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_student_unit_pinned_header, null);
        pinnedView.findViewById(com.buang.welewolf.R.id.student_unit_header_pinned_back).setOnClickListener(mOnClickListener);
        mPinnedName = (TextView) pinnedView.findViewById(com.buang.welewolf.R.id.student_unit_header_pinned_name);
        ...
        ImageFetcher.getImageFetcher().loadImage(mStudentInfo.mHeadPhoto, mHead, com.buang.welewolf.R.drawable.default_img, new RoundDisplayer());
    ...
    private void showRuleDialog(int type) {
        ...
        mDialog = DialogUtils.getNewMessageDialog(getActivity(), com.buang.welewolf.R.drawable.icon_dialog_rule, "", desc, "",  "确定",
    ...
    private void updateUnitList(OnlineStudentUnitListInfo result) {
        ...
        if (learnedUp > 0) {
            ...
            mWeekLearned.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_button_red));
        } else if (learnedUp < 0) {
            learnDb = getResources().getDrawable(com.buang.welewolf.R.drawable.icon_student_rank_down);
            learnDb.setBounds(0, 0, learnDb.getIntrinsicWidth(), learnDb.getIntrinsicHeight());
            mWeekLearned.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_main_app));
        } else {
            mWeekLearned.setText("-");
            mWeekLearned.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_text_primary));
        }
        ...
        if (learningUp > 0) {
            ...
            mWeekLearning.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_button_red));
        } else if (learningUp < 0) {
            learningDb = getResources().getDrawable(com.buang.welewolf.R.drawable.icon_student_rank_down);
            learningDb.setBounds(0, 0, learningDb.getIntrinsicWidth(), learningDb.getIntrinsicHeight());
            mWeekLearning.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_main_app));
        } else {
            mWeekLearning.setText("-");
            mWeekLearning.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_text_primary));
        }
        ...
        if (learnedLastUp > 0) {
            learnLastDb = getResources().getDrawable(com.buang.welewolf.R.drawable.icon_student_rank_up);
            learnLastDb.setBounds(0, 0, learnLastDb.getIntrinsicWidth(), learnLastDb.getIntrinsicHeight());
            mLastLearned.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_button_red));
        } else if (learnedLastUp < 0) {
            learnLastDb = getResources().getDrawable(com.buang.welewolf.R.drawable.icon_student_rank_down);
            learnLastDb.setBounds(0, 0, learnLastDb.getIntrinsicWidth(), learnLastDb.getIntrinsicHeight());
            mLastLearned.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_main_app));
        } else {
            mLastLearned.setText("-");
            mLastLearned.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_text_primary));
        }
        ...
        if (learningLastUp > 0) {
            learningLastDb = getResources().getDrawable(com.buang.welewolf.R.drawable.icon_student_rank_up);
            learningLastDb.setBounds(0, 0, learningLastDb.getIntrinsicWidth(), learningLastDb.getIntrinsicHeight());
            mLastLearning.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_button_red));
        } else if (learningLastUp < 0) {
            learningLastDb = getResources().getDrawable(com.buang.welewolf.R.drawable.icon_student_rank_down);
            learningLastDb.setBounds(0, 0, learningLastDb.getIntrinsicWidth(), learningLastDb.getIntrinsicHeight());
            mLastLearning.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_main_app));
        } else {
            mLastLearning.setText("-");
            mLastLearning.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_text_primary));
        }
    ...
    private View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            int id = v.getId();
            switch (id) {
                case com.buang.welewolf.R.id.student_unit_header_back:
                    finish();
                    break;
                case com.buang.welewolf.R.id.student_unit_header_pinned_back:
                    finish();
                    break;
                case com.buang.welewolf.R.id.student_unit_header_learned_rule:
                    showRuleDialog(0);
                    break;
                case com.buang.welewolf.R.id.student_unit_header_learning_rule:
                    showRuleDialog(1);
                    break;
            }
        }
    ...
    class StudentUnitAdapter extends SingleTypeAdapter<OnlineUnitInfo> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_student_unit_item, null);
                viewHolder = new ViewHolder();
                viewHolder.mUnitName = (TextView) convertView.findViewById(com.buang.welewolf.R.id.student_unit_item_name);
                viewHolder.mWaveView = (WaveView) convertView.findViewById(com.buang.welewolf.R.id.circle_progress);
                viewHolder.mLearned = (TextView) convertView.findViewById(com.buang.welewolf.R.id.student_unit_item_learned);
                viewHolder.mWordsCount = (TextView) convertView.findViewById(com.buang.welewolf.R.id.student_unit_item_wordscount);

...
public class LoopDetailFragment extends BaseUIFragment<UIFragmentHelper> {
    ...
    public View onCreateViewImpl(Bundle savedInstanceState) {
        return View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_home, null);
    }
    ...
    public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
        ...
        mRootView = (RelativeLayout) view.findViewById(com.buang.welewolf.R.id.main_home_layout);
        ...
        mViewPager = new MagicHeaderViewPager(getActivity()) {
            ...
            protected void initTabsArea(LinearLayout container) {
                ...
                LinearLayout tab = (LinearLayout) View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_loop_info_tab, null);

                tabWord = tab.findViewById(com.buang.welewolf.R.id.tab_word);
                tabStudent = tab.findViewById(com.buang.welewolf.R.id.tab_student);
        ...
        mHeadInfoView = (RelativeLayout) View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_loop_detail_header, null);
        ...
        mHeaderCount = (TextView) mHeadInfoView.findViewById(com.buang.welewolf.R.id.loop_detail_header_count);
        mHeaderScore = (TextView) mHeadInfoView.findViewById(com.buang.welewolf.R.id.loop_detail_header_score);
        mClassName = (TextView) mHeadInfoView.findViewById(com.buang.welewolf.R.id.loop_detail_header_class);
        mHeaderRate = (TextView) mHeadInfoView.findViewById(com.buang.welewolf.R.id.loop_detail_header_rate);
        mClassImage = (ImageView) mHeadInfoView.findViewById(com.buang.welewolf.R.id.loop_detail_header_head);
        mHeaderTip = (TextView) mHeadInfoView.findViewById(com.buang.welewolf.R.id.loop_detail_header_tip);
        mHeaderRule = (TextView) mHeadInfoView.findViewById(com.buang.welewolf.R.id.loop_detail_header_rule);
    ...
    private void updateData() {
        ...
        ImageFetcher.getImageFetcher().loadImage(reportStudentListInfo.classImage, mClassImage,
                com.buang.welewolf.R.drawable.bt_message_default_head, new RoundDisplayer());
        ...
        if (reportStudentListInfo.isLastRank()) {
            if (reportStudentListInfo.mStudyStudentList == null || reportStudentListInfo.mStudyStudentList.size() ==0) {
                ...
                if (reportStudentListInfo.averControlRate < 60) {
                    mHeaderScore.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_button_red));
                } else if (reportStudentListInfo.averControlRate < 80) {
                    mHeaderScore.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_fcc622));
                } else {
                    mHeaderScore.setTextColor(getResources().getColor(com.buang.welewolf.R.color.color_main_app));
                }
            }
    ...
    private View.OnClickListener mOnclickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case com.buang.welewolf.R.id.tab_student:
                    tabWord.setSelected(false);
                    tabStudent.setSelected(true);
                    mViewPager.setCurrentItem(0);
                    break;
                case com.buang.welewolf.R.id.tab_word:
                    UmengConstant.reportUmengEvent(UmengConstant.EVENT_HOME_STUDENT_TAB, null);
                    tabWord.setSelected(true);
                    tabStudent.setSelected(false);
                    mViewPager.setCurrentItem(1);
                    break;
                case com.buang.welewolf.R.id.loop_detail_header_rule:
                    showRuleDialog();
                    break;
            }
        }

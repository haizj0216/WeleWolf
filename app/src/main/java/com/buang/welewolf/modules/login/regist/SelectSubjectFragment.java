...
public class SelectSubjectFragment extends BaseUIFragment<UIFragmentHelper> {
	...
	public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
		...
		view.findViewById(com.buang.welewolf.R.id.select_subject_close).setOnClickListener(
				new OnClickListener() {
					@Override
		...
		mGridView = (GridView) view.findViewById(com.buang.welewolf.R.id.select_subject_grid);
	...
	public View onCreateViewImpl(Bundle savedInstanceState) {
		View view = View.inflate(getActivity(), com.buang.welewolf.R.layout.layout_regist_select_subject_activity, null);
		return view;
	}
	...
	private class SubjectGridAdapter extends
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			convertView = View.inflate(mContext,
					com.buang.welewolf.R.layout.layout_regist_select_subject_grid_item, null);
			Button subjectBtn = (Button) convertView
					.findViewById(com.buang.welewolf.R.id.subject_icon);

...
import com.knowbox.teacher.base.services.update.CheckVersionListener;
...
import com.knowbox.teacher.modules.login.SplashFragment.SplashActionListener;
...
import com.knowbox.teacher.modules.message.services.EMChatLoginListener;
...
import com.knowbox.teacher.modules.utils.BoxViewBuilder;
...
import com.knowbox.teacher.modules.utils.PackageUpdateTask;
import com.knowbox.teacher.modules.utils.PackageUpdateTask.OnUpdateProgressListener;
...
//	};
	...
	private void showSplashWindows() {
		...
		fragment.setSplashActionListener(new SplashActionListener() {
			@Override
...
//				showScene(SCENE_MAIN);
	...
	OnUpdateProgressListener mOnUpdateProgressListener = new OnUpdateProgressListener() {

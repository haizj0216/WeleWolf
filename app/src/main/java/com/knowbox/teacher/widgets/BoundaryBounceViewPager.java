...
/**
 * Created by LiuYu on 2015/11/13.
 */
public class BoundaryBounceViewPager extends ViewPager{
    /**
    ...
    public BoundaryBounceViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.BoundaryBounceViewPager);
        mOverscrollTranslation = a.getDimension(R.styleable.BoundaryBounceViewPager_overscroll_translation, DEFAULT_OVERSCROLL_TRANSLATION);
        mOverscrollAnimationDuration = a.getInt(R.styleable.BoundaryBounceViewPager_overscroll_animation_duration, DEFAULT_OVERSCROLL_ANIMATION_DURATION);
        a.recycle();
    }

...
public class BoxEmptyView extends EmptyView {
    ...
    private void initView() {
        ...
        mEmptyHintTxt2 = (TextView) findViewById(R.id.empty_hint2);
    ...
    public void showNoNetwork() {
        showEmpty(R.drawable.icon_empty_networkerror, "哎呀，网络连接失败", "请连接后重试", null, null);
    }

    @Override
    public void showEmpty(String s, String s1) {
        showEmpty(R.drawable.icon_empty_nodata, s1, null, null, null);
    }

    public void showEmpty(String hint) {
        showEmpty(R.drawable.icon_empty_nodata, hint, null, null, null);
    }
    ...
    public void showNoDataEmpty(String hint) {
        showEmpty(R.drawable.icon_empty_networkerror, hint, null, null, null);
    }
    ...
    public void showEmpty(int id, String hint) {
        if (!NetworkProvider.getNetworkProvider().getNetworkSensor().isNetworkAvailable()) {
            id = R.drawable.icon_empty_networkerror;
            hint = "当前无网络";
        }
        if (id == 0) {
            id = R.drawable.icon_empty_nodata;
        }
        final int resId = id;
    ...
    public void showEmpty() {
        showEmpty(R.drawable.icon_empty_networkerror, "获取数据失败,请稍后再试!");
    }

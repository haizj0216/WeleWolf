...
public class AddClassView extends LinearLayout implements OnClickListener {
	...
	protected void onFinishInflate() {
		...
		mYearsPicker = (NumberPicker) findViewById(R.id.regist_step_years);
		mGradePicker = (NumberPicker) findViewById(R.id.regist_step_grade);
		mClassPicker = (NumberPicker) findViewById(R.id.regist_step_class);
		mAddClasBtn = findViewById(R.id.addclass_btn);

...
import com.knowbox.teacher.base.bean.OnlineTestStudentListInfo;
...
public class SingleTestStudentFragment extends BaseUIFragment<UIFragmentHelper> implements InnerScrollerContainer {
    ...
    private void openStudentInfo(OnlineStudentInfo studentInfo) {
        ...
        showFragment(SingleTestStudentInfoFragment.newFragment(getActivity(), SingleTestStudentInfoFragment.class, mBundle));
    }

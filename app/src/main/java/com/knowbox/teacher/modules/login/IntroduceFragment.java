...
public class IntroduceFragment extends BaseUIFragment<UIFragmentHelper> {
    ...
    public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
        ...
        LoginFragment loginFragment = LoginFragment.newFragment(getActivity(), LoginFragment.class, null, AnimType.ANIM_NONE);
        if (!PreferencesController.getBoolean(BACK_FROM_LOGIN_REGIST, false)) {
            IntroduceImageFragment introduceImageFragment = IntroduceImageFragment.newFragment(getActivity(), IntroduceImageFragment.class, null);

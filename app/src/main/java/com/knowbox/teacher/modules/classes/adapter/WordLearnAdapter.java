...
public class WordLearnAdapter extends SingleTypeAdapter<OnlineWordLearnInfo.LearnStudentList> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mFragment.getActivity(), R.layout.layout_word_learn_gridview, null);
            viewHolder = new ViewHolder();
            viewHolder.mStatus = (TextView) convertView.findViewById(R.id.word_learn_status);
            viewHolder.mGridView = (AccuracGridView) convertView.findViewById(R.id.word_learn_student_list);

...
public class SplashFragment extends BaseUIFragment {
    ...
    public View onCreateViewImpl(Bundle savedInstanceState) {
        View view = View.inflate(getActivity(), R.layout.layout_splash, null);
        return view;
    }
    ...
    public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
        ...
        ImageView logo = (ImageView) view.findViewById(R.id.splash_img_logo);
//        ImageView version = (ImageView) view.findViewById(R.id.splash_img_version);
        ImageView greetImg = (ImageView) view.findViewById(R.id.splash_img_greetimg);
        try {

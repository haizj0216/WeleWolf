...
import com.knowbox.teacher.modules.message.utils.Utils;
...
public class RecorderVideoActivity extends BaseActivity implements
	...
	public void onClick(View view) {
		...
		case R.id.recorder_start:
			// start recording
			startRecording();
			ToastUtils.showShortToast(this, st1);
		...
		case R.id.recorder_stop:
			...
			new AlertDialog.Builder(this).setMessage(st2)
	...
	public void onError(MediaRecorder mr, int what, int extra) {
		...
		stopRecording();
		ToastUtils.showShortToast(this, "Recording error has occurred. Stopping the recording");

...
public class ActivityWebViewFragment extends BaseWebViewFragment {
	...
	public View onCreateViewImpl(Bundle savedInstanceState) {
		...
		View view = View.inflate(getActivity(),
				R.layout.layout_activity_webview, null);
		return view;
	}
	...
	public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
		...
		mLayout = (RelativeLayout) view.findViewById(R.id.activity_webview_layout);
		mProgress = (ProgressBar) view.findViewById(R.id.activity_webview_progress);
		mWebView = (BaseWebView) view.findViewById(R.id.activity_webview);
		setWebView(mWebView);
		...
		mBackView = (ImageView) view.findViewById(R.id.activity_title_bar_back);
		mCloseView = (TextView) view.findViewById(R.id.activity_title_close);
		mRightView = (TextView) view.findViewById(R.id.activity_right_txt);
		mTitleView = (TextView) view
		.findViewById(R.id.activity_title_bar_title);
		mMenuView = (ImageView) view.findViewById(R.id.activity_menu);
	...
	View.OnClickListener mOnClickListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			int id = v.getId();
			switch (id) {
				case R.id.activity_title_bar_back:
					...
					break;
				case R.id.activity_title_close:
					finish();
					break;
			}
		}
	...
	public void onPageLoadError(WebView view, int errorCode,
		...
		if (NetworkProvider.getNetworkProvider().getNetworkSensor()
			...
			getUIFragmentHelper().getEmptyView().showEmpty(
					R.drawable.icon_webview_empty, "点击重新加载",
					new OnClickListener() {

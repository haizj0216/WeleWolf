...
public class ForgetPasswordStepUpdatePassFragment extends StepsFragment {
	...
	public static final String ACTION_FORGET_PASSWORD = "com.knowbox.teacher.forget_password";
	...
	public View onCreateViewImpl(Bundle savedInstanceState) {
		return View.inflate(getActivity(),
				R.layout.layout_forgetpsd_step_updatepsd, null);
	}
	...
	public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
		...
		mNewPasswordEdit = (CleanableEditText) view.findViewById(R.id.new_psd_edit);
		mNewPasswordEdit.setHint(getString(R.string.forgetpsd_hint_new_password));
		mNewPasswordEdit.setMaxLength(20);
		mNewPasswordEdit.setHintTextColor(getActivity().getResources().getColor(R.color.color_text_third));
		mNewPasswordEdit.getEditText().setTextColor(getActivity().getResources().getColor(R.color.color_text_main));
		mNewPasswordEdit.setInputType(EditorInfo.TYPE_CLASS_TEXT | EditorInfo.TYPE_TEXT_VARIATION_PASSWORD);
		mSecondaryPasswordEdit = (CleanableEditText) view.findViewById(R.id.new_agin_psd_edit);
		mSecondaryPasswordEdit.setHint(getString(R.string.forgetpsd_hint_new_agin_password));
		mSecondaryPasswordEdit.setMaxLength(20);
		mSecondaryPasswordEdit.setHintTextColor(getActivity().getResources().getColor(R.color.color_text_third));
		mSecondaryPasswordEdit.getEditText().setTextColor(getActivity().getResources().getColor(R.color.color_text_main));

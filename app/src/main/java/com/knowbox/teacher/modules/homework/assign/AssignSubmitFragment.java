...
import com.knowbox.teacher.base.bean.OnlineAssignSuccessInfo;
...
import com.knowbox.teacher.base.bean.OnlineEstimateTimeInfo;
...
public class AssignSubmitFragment extends BaseUIFragment<UIFragmentHelper> {
    ...
    private void showMakeOutSuccessFragment(OnlineAssignSuccessInfo info) {
        ...
        AssignSuccessFragment fragment = AssignSuccessFragment
                .newFragment(getActivity(),

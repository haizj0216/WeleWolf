...
public class AboutAppFragment extends BaseUIFragment {
	...
	public View onCreateViewImpl(Bundle savedInstanceState) {
		...
		View view = View
				.inflate(getActivity(), R.layout.layout_about_app, null);
		return view;
	}
	...
	public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
		...
		((TextView) view.findViewById(R.id.profile_assist_version))
				.setText("当前版本 : " + versionName);
//		view.findViewById(R.id.profile_assist_intro).setOnClickListener(
//				mOnClickListener);
		view.findViewById(R.id.profile_assist_update).setOnClickListener(
				mOnClickListener);
	}
...
//				break;
			...
			// 检测更新
			case R.id.profile_assist_update:

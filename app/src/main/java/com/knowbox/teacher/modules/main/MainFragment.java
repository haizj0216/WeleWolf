...
import com.knowbox.teacher.base.bean.OnlineGlobalInfo;
...
import com.knowbox.teacher.welewolf.fragment.*;
...
//	private int mStartUpCount;
	...
	public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
		...
		mTabGroup = view.findViewById(R.id.main_tab_group);

		mTabList = view.findViewById(R.id.main_tab_list);
		mTabList.setOnClickListener(mOnClickListener);
		mTabGame = view.findViewById(R.id.main_tab_game);
		mTabGame.setOnClickListener(mOnClickListener);
		mTabMessage = view.findViewById(R.id.main_tab_message);
		mTabMessage.setOnClickListener(mOnClickListener);
		mTabClassTips = view.findViewById(R.id.main_list_tips);
		mTabProfileTips = view.findViewById(R.id.main_message_tips);
		mTabHomeworkTips = view.findViewById(R.id.main_game_tips);
		mViewPager = (ViewPager) view.findViewById(R.id.main_pagers);
		...
		mLoadingImg = (ImageView) view.findViewById(R.id.loading_anim);
	...
	private void showNotifyDialog(final Stack<OnlineGlobalInfo.OnlineGlobalInfoItem> items) {
		...
		switch (item.mInfoType) {
			case OnlineGlobalInfo.TYPE_CLASS_TRANSFER_NOTIFYTION:
				icon = R.drawable.icon_class_transfer_tip;
			...
			case OnlineGlobalInfo.TYPE_CLASS_TRANSFER_REFUE:
				...
				icon = R.drawable.icon_class_transfer_refuse;
				confirm = "我知道了";
				break;
			case OnlineGlobalInfo.TYPE_CLASS_TRANSFER_SUCCESS:
				...
				icon = R.drawable.icon_class_transfer_sucess;
				confirm = "我知道了";
				break;

...
public class CompetitionTypeFragment extends BaseUIFragment<UIFragmentHelper> implements View.OnClickListener, View.OnLongClickListener {
    ...
    public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
        ...
        View loopLayout = view.findViewById(R.id.ll_competition_loop_create);
        View testLayout = view.findViewById(R.id.ll_competition_singletest_create);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ll_competition_loop_create:
                if (isClicked) break;
                isClicked = true;
                showAssignMatchFragment(CompetitionItem.TYPE_LOOP_MATCH);
                break;
            case R.id.ll_competition_singletest_create:
                if (isClicked) break;
                isClicked = true;

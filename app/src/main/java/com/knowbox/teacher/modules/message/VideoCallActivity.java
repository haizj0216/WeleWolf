...
import com.knowbox.teacher.modules.message.utils.CameraHelper;
...
//    private RelativeLayout btnsContainer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_message_video_call);
...
//        btnsContainer = (RelativeLayout) findViewById(R.id.ll_btns);
            ...
            if (!cameraHelper.isStarted()) {
                if (!isInComingCall) {
                    try {
                        ...
                        ToastUtils.showShortToast(VideoCallActivity.this, st1);
                    }
                }
                ...
                case ACCEPTED: // 电话接通成功
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            openSpeakerOn();
                            handsFreeImage.setImageResource(R.drawable.chat_speaker_on);
    ...
    public void onClick(View v) {
        ...
        case R.id.iv_mute: // 静音开关
            if (isMuteState) {
                // 关闭静音
                muteImage.setImageResource(R.drawable.chat_mute_normal);
                audioManager.setMicrophoneMute(false);
                isMuteState = false;
            } else {
                // 打开静音
                muteImage.setImageResource(R.drawable.chat_mute_on);
        ...
        case R.id.iv_handsfree: // 免提开关
            if (isHandsfreeState) {
                // 关闭免提
                handsFreeImage.setImageResource(R.drawable.chat_speaker_normal);
                closeSpeakerOn();

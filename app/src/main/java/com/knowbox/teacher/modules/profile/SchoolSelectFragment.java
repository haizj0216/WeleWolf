...
import com.knowbox.teacher.modules.login.searchschool.SchoolListLoader;
import com.knowbox.teacher.modules.login.searchschool.SchoolLoadListener;
...
import com.knowbox.teacher.widgets.pinned_listview.PinnedHeaderAdapter;
...
public class SchoolSelectFragment extends BaseUIFragment<UIFragmentHelper> {
    ...
    public void onViewCreatedImpl(View view, Bundle savedInstanceState) {
        ...
        mCreateView = view.findViewById(R.id.dialog_choose_school_not_found);
            ...
            public void onPostLoad(List<PinyinIndexModel> data,
                ...
                if (data != null && data.size() > 0) {
                    ...
                    View previewTextView = inflater.inflate(
                            R.layout.index_bar_preview_view, mListView, false);

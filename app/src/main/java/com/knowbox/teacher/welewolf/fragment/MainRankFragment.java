...
import com.knowbox.teacher.base.bean.BannerInfoItem;
import com.knowbox.teacher.base.bean.OnlineRankItemInfo;
import com.knowbox.teacher.base.bean.OnlineRankListInfo;
import com.knowbox.teacher.base.bean.OnlineStudentInfo;
import com.knowbox.teacher.base.bean.OnlineStudentRankInfo;
...
public class MainRankFragment extends BaseUIFragment<UIFragmentHelper> {
    ...
    public View onCreateViewImpl(Bundle savedInstanceState) {
        return View.inflate(getActivity(), R.layout.layout_main_list, null);
    }
    ...
    private void initBanner() {
        header = View.inflate(getActivity(), R.layout.header_homework, null);
        final RelativeLayout bannerLayout = (RelativeLayout) header.findViewById(R.id.bank_focus_layou);
        ...
        mPagerHintPanel =
                (LinearLayout) header.findViewById(R.id.blockade_focus_pager_hint_panel);
    ...
    class ListAdapter extends SingleTypeAdapter<OnlineRankItemInfo> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(getActivity(), R.layout.layout_main_list_item, null);
                viewHolder = new ViewHolder();

                viewHolder.mBg = convertView.findViewById(R.id.main_list_item_bg);
                viewHolder.mMoreView = (TextView) convertView.findViewById(R.id.main_list_item_more);
                viewHolder.mStudentList = (LinearLayout) convertView.findViewById(R.id.main_list_item_student);
            ...
            switch (rankItemInfo.type) {
                case 0:
                    viewHolder.mBg.setBackgroundResource(R.drawable.rank_lv);
                    break;
                case 1:
                    viewHolder.mBg.setBackgroundResource(R.drawable.rank_popularity);
                    break;
                case 2:
                    viewHolder.mBg.setBackgroundResource(R.drawable.rank_score);
            ...
            for (int i = 0; i < rankItemInfo.mStudentInfos.size(); i++) {
                ...
                View view = View.inflate(getActivity(), R.layout.layout_main_list_student, null);
                ImageView mHead = (ImageView) view.findViewById(R.id.student_head_photo);
                ImageFetcher.getImageFetcher().loadImage(studentInfo.mHeadPhoto, mHead, 0, new RoundDisplayer());

                TextView mName = (TextView) view.findViewById(R.id.student_name);
                mName.setText(studentInfo.mStudentName);

                ImageView mRank = (ImageView) view.findViewById(R.id.student_head_rank);
                switch (i) {
                    case 0:
                        mRank.setImageResource(R.drawable.ic_rank_crown_1st);
                        break;
                    case 1:
                        mRank.setImageResource(R.drawable.ic_rank_crown_2nd);
                        break;
                    case 2:
                        mRank.setImageResource(R.drawable.ic_rank_crown_3rd);
                        break;
                    default:
    ...
    class FocusPagerAdapter extends PagerAdapter {
        ...
        public FocusPagerAdapter(final List<BannerInfoItem> advInfoList) {
            ...
            for (int i = 0; i < items.size(); i++) {
                ...
                View view = View.inflate(getActivity(), R.layout.layout_homework_banner_item, null);
                final ImageView imageView = (ImageView) view.findViewById(R.id.ivHomeworkBannerItem);
